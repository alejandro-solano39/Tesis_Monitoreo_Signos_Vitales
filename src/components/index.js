...
import AlertHistory from "./DashboardComponents/AlertHistory";
...
export{
    Nav, PersonalCard, MedicalCard, DistanceDisplay, TemperatureDisplay, HeartRate, OxygenLevel ,PatientAlerts, PatientTemperature, WeatherComponent, Profile, Slider, 
    Dashboard, PatientTable,DoctorWelcomeCard, Note, AlertHistory, PatientList, HomeDashboard, PatientForm, 
